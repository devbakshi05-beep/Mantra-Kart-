...
namespace Ecom_Project_2026.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        private static bool isEmailConfirmation = false;
        ...
        //public IEnumerable<ShoppingCart> ListCart { get; private set; }
        ...
        public IActionResult Index()
        {
            ...
            ShoppingCartVM.OrderHeader.ApplicationUser = _unitOfWork.ApplicationUser.FirstOrDefault(au =>
            au.Id == claims.Value);

            foreach (var list in ShoppingCartVM.ListCart)
            {
                list.Price = SD.GetPriceBasedOnQuantity(list.Count, list.Product.Price,
                   list.Product.Price50, list.Product.Price);
        ...
        public async Task<IActionResult> IndexPost()
        {
            ...
            var claims = claimsIdendity.FindFirst(ClaimTypes.NameIdentifier);
